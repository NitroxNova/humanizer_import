...
static func store_textures_from_overlay(writer:ZIPPacker ,overlay_config:Dictionary,input_folder:String,equip_id:String):
	for texture_name in overlay_config:
